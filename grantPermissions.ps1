$DestinationTenantId = "xxx" # Update with your tenant Id
$MsiName = "add-user-to-group" # Name of system-assigned or user-assigned managed service identity. (System-assigned use same name as resource).
...
Connect-MgGraph -TenantId $DestinationTenantId -ForceRefresh
